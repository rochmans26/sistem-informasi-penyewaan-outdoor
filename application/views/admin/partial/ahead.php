...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="<?= base_url('/assets/admin/assets/') ?>" data-template="vertical-menu-template-free">
...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" href="<?= base_url(); ?>/assets/upload/default.png" />
    ...
    <div class="layout-container">
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo">
          <a href="index.html" class="app-brand-link">
            <span class="app-brand-logo demo">
              <img src="<?= base_url(); ?>/assets/upload/default.png" alt="" height="40px">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item">
            <a href="<?= site_url('admin/mitem'); ?>" class="menu-link">
              <i class="menu-icon tf-icons bx bxs-dashboard"></i>
              <div data-i18n="Analytics">Manage Produk</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="<?= site_url('admin/kategori'); ?>" class="menu-link">
              <i class="menu-icon tf-icons bx bxs-dashboard"></i>
              <div data-i18n="Analytics">Manage Kategori</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="<?= site_url('admin/mtransaction'); ?>" class="menu-link">
              <i class="menu-icon tf-icons bx bxs-dashboard"></i>
              <div data-i18n="Analytics">Manage Transaksi</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="<?= site_url('admin/mtransaction/sewa'); ?>" class="menu-link">
              <i class="menu-icon tf-icons bx bxs-dashboard"></i>
              <div data-i18n="Analytics">Manage Sewa</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="<?= site_url('admin/muser'); ?>" class="menu-link">
              <i class="menu-icon tf-icons bx bxs-dashboard"></i>
              <div data-i18n="Analytics">Manage User</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="<?= site_url('admin/mtransaction/pendapatan'); ?>" class="menu-link">
              <i class="menu-icon tf-icons bx bxs-dashboard"></i>
